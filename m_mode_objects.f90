...
!			     	      nullify(maux%next) 		              
    ...
    !**************************************************************************************************************************************
     ! Subroutine defined in m_mode_objects where convolution, tresholding, identification of objects, attributes calculation and merging algorithms are made
      SUBROUTINE mode_ObjectIdentf(rowSize, colSize, Field, convField, restoreField, weight, total_interest_tresh, grid_res, mask, maskObj, totalObj, objects)
         Implicit None
	 ...
	 ! Convolution process
         call convolution(convField, Field, cfilter, rowSize, colSize)
